...
export default function ProjectCard({ title, description, tags, link, image }: any) {
  return (
    <div className="group relative bg-slate-900/50 border border-slate-800 rounded-xl hover:-translate-y-2 transition-all duration-300 hover:border-blue-500/50 hover:shadow-[0_10px_30px_-15px_rgba(37,99,235,0.3)] overflow-hidden flex flex-col">
      {image && (
